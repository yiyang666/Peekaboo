...
export default function PeekabooCharacters({ interactionState }: Props) {
    ...
    <div className="flex w-full max-w-lg justify-center">
      ...
      >
        ...
        >
          ...
          />
          <g id="peekaboo-eye-purple-L" transform="translate(192, 92)">
            <rect
          ...
          <g id="peekaboo-eye-purple-R" transform="translate(228, 92)">
            <rect
        ...
        >
          ...
          />
          <g id="peekaboo-eye-black-L" transform="translate(255, 158)">
            <ellipse
          ...
          <g id="peekaboo-eye-black-R" transform="translate(286, 158)">
            <ellipse
        ...
        >
          ...
          />
          <g id="peekaboo-eye-orange-L" transform="translate(85, 225)">
            <circle
          ...
          <g id="peekaboo-eye-orange-R" transform="translate(115, 225)">
            <circle
        ...
        >
          ...
          <g id="peekaboo-eye-yellow-L" transform="translate(352, 198)">
            <circle
          ...
          <g id="peekaboo-eye-yellow-R" transform="translate(374, 198)">
            <circle
